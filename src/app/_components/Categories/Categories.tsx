      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 flex flex-col justify-center">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <p className="text-[10px] font-bold text-[#00B864] tracking-widest uppercase">
                Newsletter
              </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-xl">
            <input
              ...
              className="flex-grow px-6 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500/20 bg-white shadow-sm"
            />
            ...
            <div className="space-y-4">
              <button className="w-full bg-white/5 hover:bg-white/10 border border-white/10 p-4 rounded-2xl flex items-center gap-4 transition text-left group">
                <svg
                  ...
                  viewBox="0 0 384 512"
                >
                  <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 21.8-88.5 21.8-11.4 0-51.1-19-81.4-18.6-38.6.5-81.9 25.1-105.2 69.4-46.9 89.1-15.8 213.5 30.2 282.7 22.4 33.8 54.1 71.3 90 70.2 32.2-1.2 46.8-21.4 86.8-21.4s52.7 21.4 86.5 20.8c36.6-.6 64.2-34.1 86.1-66.2 25.2-37.2 35.6-73.3 35.9-75.1-1.1-.3-69.1-26.7-69.2-104.8zM232.1 79.2c16.1-20.2 26.9-48.2 23.9-76.2-24.1 1-53.1 16.1-70.4 36.3-15.5 18.1-28.9 45.9-25.2 73.1 26.3 2 54-14.7 71.7-33.2z" />
                </svg>
                <div>
              ...
              <button className="w-full bg-white/5 hover:bg-white/10 border border-white/10 p-4 rounded-2xl flex items-center gap-4 transition text-left">
                <svg
                  ...
                  viewBox="0 0 512 512"
                >
                  <path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 58.9-34.1c18-10.3 25.5-30.4 25.5-50.4s-7.5-40.1-25.5-50.4zM325.3 277.7l60.1 60.1L104.6 499l220.7-221.3z" />
                </svg>
                <div>
